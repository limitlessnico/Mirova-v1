...
def obtener_clasificacion_mirova(vrp_mw, es_alerta):
    ...
    # Conversión a Watts para umbrales MIROVA
    v = vrp_mw * 1000000
...
def procesar():
    ...
    log_debug("INICIO SCRAPER: SINCRONIZACIÓN Y CLASIFICACIÓN", "INFO")
    ...
    try:
        ...
        for fila in filas:
            ...
            # --- LÓGICA DE TIPO DE REGISTRO (Falso Positivo vs Alerta) ---
            ...
            # --- OBTENER CLASIFICACIÓN DINÁMICA ---
            ...
            if not registro_previo.empty:
                ...
                # Descarga de fotos solo para registros frescos
        ...
        log_debug("Proceso completado con clasificaciones y falsos positivos.", "EXITO")
